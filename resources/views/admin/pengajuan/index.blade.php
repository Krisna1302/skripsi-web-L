    ...
    <div class="filter-card" data-aos="fade-up" data-aos-delay="50">
        <form method="GET" action="{{ route('admin.pengajuan.index') }}">
            ...
            <div class="mt-3">
                ...
                <a href="{{ route('admin.pengajuan.index') }}" class="btn btn-secondary">Reset</a>
            </div>
        </form>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group mt-2" role="group">
                        @if($status == 'menunggu')
                        <form action="{{ route('admin.pengajuan.approve', $p->id) }}" method="POST" class="d-inline">
                            @csrf
                            <button class="btn btn-success btn-sm" onclick="return confirm('Yakin approve?')">
                                <i class="bi bi-check-circle"></i> Approve
                            </button>
                        </form>
                        <form action="{{ route('admin.pengajuan.reject', $p->id) }}" method="POST" class="d-inline">
                            @csrf
                            <button class="btn btn-danger btn-sm" onclick="return confirm('Yakin reject?')">
                                <i class="bi bi-x-circle"></i> Reject
                            </button>
                        </form>
                        @endif
                        <a href="{{ route('admin.pengajuan.edit', $p->id) }}" class="btn btn-primary btn-sm">
