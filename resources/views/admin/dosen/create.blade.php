...
<div class="container" data-aos="fade-up">
    <h2 data-aos="fade-down" data-aos-duration="800">Tambah Dosen</h2>
        ...
        <form action="{{ route('dosen.store') }}" method="POST">
            ...
            <div class="mb-3" data-aos="fade-up" data-aos-delay="350">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="kaprodi" class="form-control" placeholder="Masukkan program studi" required>
                </div>
            </div>
